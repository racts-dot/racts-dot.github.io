...
(function () {
  ...
  pieces.forEach(function (p) {
    ...
    // "swipe" left out means the hint too: above, a page with no swipe settings has its
    // swipe piece switched to swipe-hint.js, whose key no longer matches "swipe". Found
    // 23 Sep 2026 when an app that never had swipe gained the hint during the migration.
    if (p.key === "swipe-hint" && omit.indexOf("swipe") !== -1) return;
